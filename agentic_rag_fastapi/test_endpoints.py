...
doc = Document()
doc.add_paragraph(
    "Google's Agentic RAG architecture involves multiple agents working together to provide grounded answers."
)
doc.add_paragraph(
    "The role of the Sufficient Context Agent is to determine if the retrieved context is sufficient, and if not, suggest feedback."
)
...
try:
    r = requests.post(
        "http://127.0.0.1:8000/vanilla-ask",
        json={
